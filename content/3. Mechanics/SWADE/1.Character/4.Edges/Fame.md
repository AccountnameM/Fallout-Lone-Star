...
She makes double the normal fee when performing for pay (see [[Traits#Performance (Spirit)|Performance]], page 32). She can also use her celebrity to add +1 to Persuasion rolls if a target is friendly and knows who she is (a Common Knowledge roll modified by how likely the individual is to know the celebrity). 
